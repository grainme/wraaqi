...
export function CheckProfile() {
  ...
  const getImageFromSupabase =  (user) => {
                    ...
                    <div className="flex flex-col gap-6">
                      {options.map(({ checked, label }) => (
                        <Switch
                          ...
                          labelProps={{
                            className:
                              "text-sm font-normal text-blue-gray-500 font-GS",
                          }}
                        />
                      ))}
                    </div>
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-row gap-5">
                  <div>
                    ...
                    <input
                      className="bg-transparent border-2 pr-10 pl-2 py-1 rounded-lg"
                      placeholder={user.adresse.ville}
                    ></input>
                  </div>
                  <div>
                    <div className="font-GS font-semibold text-[12px]">
                    ...
                    <input
                      className="bg-transparent border-2 pr-10 pl-2 py-1 rounded-lg"
                      placeholder={user.adresse.residence}
                    ></input>
                  </div>
                </div>
              </div>
