      ...
      <div className="w-full lg:w-3/5 mt-24">
        <div className="text-center">
          ...
          <Typography
            variant="paragraph"
            color="blue-gray"
            className="text-lg font-CG font-normal"
          >
            Devenez membre chez Wraaqi.
          </Typography>
        </div>
        <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          <div className="mb-1 flex flex-col gap-6">
            ...
            <Typography
              variant="small"
              color="blue-gray"
              className="-mb-3 font-medium font-CG"
            >
              Mot de passe
            </Typography>
            <Input
          ...
          {userNotFound ? (
            <div className="font-CG flex justify-center items-center text-red-500 m-2 text-[14px] font-semibold">
              User Not Found!
            </div>
          ) : null}
          ...
          <div className="flex items-center justify-between gap-2 mt-6">
            <Typography
              variant="small"
              className="font-medium text-gray-900 font-CG"
            >
              <Link to="/auth/Pwd">Mot de passe oublié?</Link>
            </Typography>
          </div>
          <Typography
            variant="paragraph"
            className="text-center text-blue-gray-500 font-medium mt-4 font-CG"
          >
            Pas encore inscrit ?
            <Link to="/auth/sign-up" className="text-gray-900 ml-1 font-CG">
              Faites une demande
            </Link>
          </Typography>
        </form>
