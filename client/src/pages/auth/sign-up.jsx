...
export function SignUp() {
  ...
  const pushUserInfos = () => {
    ...
    if (age >= 18) {
      ...
      axios
        .post("http://localhost:8080/demandeInscription", body)
        .then((response) => {
  ...
  return (
    <section className="m-8 flex">
      <div className="w-2/5 fixed top-0 right-0 min-h-screen lg:block">
        <video
          src="/img/video2.mp4"
          className="min-h-screen w-full object-cover max-w-full"
          autoPlay
          loop
          muted
          playsInline
      ...
      <div className="w-full lg:w-3/5 flex flex-col items-center justify-center">
        <div className="text-center">
          <Typography variant="h2" className="font-bold mb-4 font-CG">
            Rejoignez-nous aujourd'hui
          </Typography>
          <Typography
            variant="paragraph"
            color="blue-gray"
            className="text-lg font-normal font-CG"
          >
            Entrez votre informations personnelles pour vous inscrire.
          </Typography>
        </div>
        <form className="mt-5 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          <div className="mb-1 flex flex-col gap-6">
            <Typography
              variant="small"
              color="blue-gray"
              className="-mb-6 font-medium font-CG"
            >
              Prénom
            </Typography>
            <Input
          ...
          {accdemande ? (
            <div className="flex justify-center items-center text-green-500 m-2 text-[14px] font-CG font-semibold">
              demande envoye par succ!
            </div>
          ) : null}
          ...
          <Typography
            variant="paragraph"
            className="text-center font-CG text-blue-gray-500 font-medium mt-4"
          >
            Vous avez déjà un compte?
            <Link to="/auth/sign-in" className="text-gray-900 ml-1 font-CG">
              Connectez-vous
            </Link>
          </Typography>
        </form>
